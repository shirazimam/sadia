 ...
 * This template can be overridden by copying it to yourtheme/bdp_templates/archive/famous.php.
...
add_action('bd_archive_design_format_function', 'bdp_archive_famous_template', 10, 1);

if (!function_exists('bdp_archive_famous_template')) {

    function bdp_archive_famous_template($bdp_settings) {
