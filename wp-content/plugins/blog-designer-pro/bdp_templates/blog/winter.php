 ...
 * This template can be overridden by copying it to yourtheme/bdp_templates/blog/winter.php.
...
<div class="<?php echo $class_name; ?> bdp_blog_single_post_wrapp <?php echo $category; ?>">
    ...
    <div class="blog_header">
        ...
        <div class="metadatabox"><?php
            ...
            if ($display_date == 1 && (isset($bdp_settings['display_tag']) && $bdp_settings['display_tag'] == 1 && has_tag())) {
                echo '<span>-</span>';
            }
                    ...
                    if ($bdp_settings["display_taxonomy_" . $taxonomy] == 1) {
                        ...
                        if (isset($taxonomy) && $taxonomy != 'product_cat') {
                            if (isset($term_list) && !empty($term_list)) {
                                ?>
                                <div class="category-link <?php echo ($taxonomy_link) ? 'bdp_has_link' : 'bdp_no_links'; ?>">
    ...
    <div class="post_content_wrap">
        ...
        <p><?php echo bdp_get_content($post->ID, $bdp_settings['rss_use_excerpt'], $bdp_settings['txtExcerptlength'], $bdp_settings); ?>
            <?php 
            ...
            if ($read_more_link == 1 && $bdp_settings['rss_use_excerpt'] != 0 && $read_more_on == 2) {
