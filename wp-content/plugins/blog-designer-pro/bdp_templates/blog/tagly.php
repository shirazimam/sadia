...
?>
<div class="blog_template bdp_blog_template tagly bdp_blog_single_post_wrapp <?php echo $category; ?>">
                        ...
                        if (isset($taxonomy) && $taxonomy != 'product_cat') {
                            if (isset($term_list) && !empty($term_list)) {
                                ...
                                <div class="tags taxonomies <?php echo ($taxonomy_link) ? 'bdp_has_links' : 'bdp_no_links'; ?>">
                                    <span class="link-lable"> <i class="fas fa-tags"></i> <?php echo $taxonomy_single->label; ?>&nbsp;:&nbsp; </span>
                                    <?php
