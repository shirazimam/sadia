                    ...
                    <div class="post-media">
                        <div class="bdp-post-image">
                            ...
                            <div class="year-number">
                                <?php echo (isset($bdp_settings['dsiplay_date_from']) && $bdp_settings['dsiplay_date_from'] == 'modify') ? get_the_modified_time('Y') : get_the_time('Y'); ?>
                            </div>
                            <?php
                ...
                if (isset($bdp_settings['display_tag']) && $bdp_settings['display_tag'] == 1) {
                    ...
                    if ($tags_list):
                        ...
                        <div class="tags <?php echo ($tag_link) ? 'bdp-no-links' : 'bdp-has-links'; ?>">
                            <span class="link-lable"> <i class="fas fa-bookmark"></i></i> <?php _e('Tags', BLOGDESIGNERPRO_TEXTDOMAIN); ?>:&nbsp; </span>
                            <?php
                            print_r($tags_list);
                            $show_sep = true;
                            ?>
                        ...
                        if ($bdp_settings['display_comment'] == 1) {
                            ...
                            <span class="post-comment">
                                ...
                                if (isset($bdp_settings['disable_link_comment']) && $bdp_settings['disable_link_comment'] == 1) {
                                    ...
                                    comments_popup_link(__('Leave a Comment', BLOGDESIGNERPRO_TEXTDOMAIN), __('1 comment', BLOGDESIGNERPRO_TEXTDOMAIN), '% ' . __('comments', BLOGDESIGNERPRO_TEXTDOMAIN), 'comments-link', __('Comments off', BLOGDESIGNERPRO_TEXTDOMAIN));
                                }
                                ?>
                            </span>
                            <?php
