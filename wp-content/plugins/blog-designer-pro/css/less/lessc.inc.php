...
if (!class_exists('bdp_lessc')) {
    ...
    class bdp_lessc {
        ...
        protected function injectVariables($args) {
            $this->pushEnv();
            $parser = new bdp_lessc_parser($this, __METHOD__);
        ...
        protected function makeParser($name) {
            $parser = new bdp_lessc_parser($this, $name);
        ...
        protected function newFormatter() {
            $className = "bdp_lessc_formatter_lessjs";
            if (!empty($this->formatterName)) {
                if (!is_string($this->formatterName))
                    return $this->formatterName;
                $className = "bdp_lessc_formatter_$this->formatterName";
            }
...
// syntax tree
if (!class_exists('bdp_lessc_parser')) {

    class bdp_lessc_parser {
        ...
        public function __construct($lessc, $sourceName = null) {
            ...
            if (!self::$operatorString) {
                self::$operatorString = '(' . implode('|', array_map(array('bdp_lessc', 'preg_quote'), array_keys(self::$precedence))) . ')';

                $commentSingle = bdp_lessc::preg_quote(self::$commentSingle);
                $commentMultiLeft = bdp_lessc::preg_quote(self::$commentMultiLeft);
                $commentMultiRight = bdp_lessc::preg_quote(self::$commentMultiRight);
        ...
        protected function isDirective($dirname, $directives) {
            ...
            $pattern = implode("|", array_map(array("bdp_lessc", "preg_quote"), $directives));
        ...
        protected function expressionList(&$exps) {
            ...
            $exps = bdp_lessc::compressList($values, ' ');
            return true;
        }
        ...
        public function propertyValue(&$value, $keyName = null) {
            ...
            $value = bdp_lessc::compressList($values, ', ');
            return true;
        }
        ...
        protected function openString($end, &$out, $nestingOpen = null, $rejectStrs = null) {
            ...
            $stop = array("'", '"', "@{", $end);
            $stop = array_map(array("bdp_lessc", "preg_quote"), $stop);
    ...
    protected function literal($what, $eatWhitespace = null) {
        ...
        if (!isset(self::$literalCache[$what])) {
            self::$literalCache[$what] = bdp_lessc::preg_quote($what);
        }
    ...
    protected function to($what, &$out, $until = false, $allowNewline = false) {
        ...
        if (!$this->match('(' . $validChars . '*?)' . bdp_lessc::preg_quote($what), $m, !$until))
            return false;
        if ($until)
...
if (!class_exists('bdp_lessc_formatter_classic')) {

class bdp_lessc_formatter_classic {
...
if (!class_exists('bdp_lessc_formatter_compressed')) {

class bdp_lessc_formatter_compressed extends bdp_lessc_formatter_classic {
...
if (!class_exists('bdp_lessc_formatter_lessjs')) {

class bdp_lessc_formatter_lessjs extends bdp_lessc_formatter_classic {
