...
if( !class_exists('QcPluginUpgradeToProNotice') )
{
	class QcPluginUpgradeToProNotice {
		...
		function func_qc_external_upgrade_link()
		{
		    ...
		    $link_text = '<span class="qc-up-pro-link" style="font-weight: bold; color: '.$this->link_color.'">'.$this->link_text.'</span>';
...
{ 
	...
	$instance_ilistf->upgrade_link = "https://www.quantumcloud.com/products/woo-tabbed-category-product-listing/";
	$instance_ilistf->link_color = "#22A7F0";
	//$instance_ilistf->link_text = "Upgrade To Pro";
	//$instance_ilistf->link_class = "";
	//$instance_ilistf->link_target = "_blank";

	$instance_ilistf->plugin_slug = 'iList'; //Plugin Slug. i.e. Folder Name
	$instance_ilistf->plugin_main_file = 'woo-tabbed-category-product-listing.php'; //Primary file of the pluign
	$instance_ilistf->plugin_menu_slug = 'edit.php?post_type=shop_order'; //Main Menu Slug
