...
<div class="editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important; min-width:1200px !important">
	...
	<div id="nls-wrapper">
		...
		<div id="css_slider_editor_wrap" class="ho_row_ ho_column_ ho_group_" title="<?php _e("Slider Custom CSS/JS Editor",'revslider') ?>" style="display:none;">
			<div id="show_global_styles" class="show_global_styles revblue button-primary"><?php _e('Edit Depricated Global Styles', 'revslider'); ?></div>
			<span class="cbi-title"><?php _e("Slider CSS:",'revslider')?></span>
			<div class="css_editor_novice_wrap">
				<textarea id="textarea_show_slider_styles" rows="20" style="width:100%"></textarea>
			</div>
			<span class="cbi-title"><?php _e("Slider JavaScript:",'revslider')?></span>
			<div class="css_editor_novice_wrap">
		...
		<form id="tp_rs_a_form" name="form_layers" class="form_layers notselected">
			...
			<div class="layer-settings-toolbar " id="rs-style-content-wrapper" style="">
				...
				<div id="css_static_editor_wrap" class="ho_row_ ho_column_ ho_group_" title="<?php _e("Global Style Editor (Depricated)",'revslider') ?>" style="display:none;">
						...
						<div class="inner-settings-wrapper">
							<div id="tp-idle-state-advanced-style" style="float:left; padding-left:20px;">
								...
								<ul class="rs-layer-animation-settings-tabs" style="display:inline-block; ">
									...
									<li data-content="#style-sub-filters"><?php _e("Filters",'revslider'); ?></li>
									<!--<li data-content="#style-sub-shadows"><?php _e("Shadow",'revslider'); ?></li>-->
								...
								<span id="style-sub-shadows" class="rs-layer-toolbar-box" style="display:none;border:none;">
									...
									<input data-suffix="px" type="text" style="width:105px;" class="input-deepselects rs-inoutanimationfield textbox-caption rs-layer-input-field tipsy_enabled_top" title="<?php _e("Blur Radius",'revslider'); ?>"  id="ds_blur_idle" name="ds_blur_idle" value="0"  data-selects="0||Custom||10||20" data-svalues ="0||5||10||20" data-icons="minus||wrench||filter||filter">
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>
									...
									<input data-suffix="px" type="text" style="width:105px;" class="input-deepselects rs-inoutanimationfield textbox-caption rs-layer-input-field tipsy_enabled_top" title="<?php _e("Spread Radius",'revslider'); ?>"  id="ds_spread_idle" name="ds_spread_idle" value="0"  data-selects="0||Custom||10||20" data-svalues ="0||5||10||20" data-icons="minus||wrench||filter||filter">
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>-->
									<!-- SHADOW COLOR START-->								
									<input type="text" class="rs-staticcustomstylechange rs-layer-input-field my-color-field tipsy_enabled_top" title="<?php _e("Shadow Color",'revslider'); ?>" style="width:150px" id="ds_color_idle" name="ds_color_idle" value="transparent" />
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>
									...
									<input data-suffix="" data-steps="0.05" data-min="0" data-max="1" class="rs-staticcustomstylechange pad-input text-sidebar rs-layer-input-field tipsy_enabled_top" title="<?php _e("Shadow Opacity",'revslider'); ?>" style="width:50px" type="text" id="ds_opacity_idle" name="ds_opacity_idle" value="1">
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>
							...
							<div id="tp-hover-state-advanced-style" style="float:left;display:none; padding-left:20px;">
									<ul class="rs-layer-animation-settings-tabs" style="display:inline-block;min-width:615px ">
										...
										<li data-content="#hover-sub-filters"><?php _e("Filters",'revslider'); ?></li>
										<!--<li data-content="#hover-sub-shadows"><?php _e("Shadow",'revslider'); ?></li>-->
								...
								<span id="hover-sub-shadows" class="rs-layer-toolbar-box" style="display:none;border:none;">
									...
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>
									<i class="rs-mini-layer-icon fa-icon-spinner rs-toolbar-icon tipsy_enabled_top" title="<?php _e("Blur Radius",'revslider'); ?>"  style="margin-right:8px;font-size:20px;line-height:26px"></i>
									<input data-suffix="px" type="text" style="width:105px;" class="input-deepselects rs-inoutanimationfield textbox-caption rs-layer-input-field tipsy_enabled_top" title="<?php _e("Blur Radius",'revslider'); ?>"  id="ds_blur_hover" name="ds_blur_hover" value="0"  data-selects="0||Custom||10||20" data-svalues ="0||5||10||20" data-icons="minus||wrench||filter||filter">
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>
									<!--<i class="rs-mini-layer-icon fa-icon-bullseye rs-toolbar-icon tipsy_enabled_top" title="<?php _e("Spread Radius",'revslider'); ?>"  style="margin-right:8px;font-size:20px;line-height:26px"></i>
									<input data-suffix="px" type="text" style="width:105px;" class="input-deepselects rs-inoutanimationfield textbox-caption rs-layer-input-field tipsy_enabled_top" title="<?php _e("Spread Radius",'revslider'); ?>"  id="ds_spread_hover" name="ds_spread_hover" value="0"  data-selects="0||Custom||10||20" data-svalues ="0||5||10||20" data-icons="minus||wrench||filter||filter">
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>-->
									<!-- SHADOW COLOR START-->								
									<input type="text" class="rs-staticcustomstylechange rs-layer-input-field my-color-field tipsy_enabled_top" title="<?php _e("Shadow Color",'revslider'); ?>" style="width:150px" id="ds_color_hover" name="ds_color_hover" value="transparent" />
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>

									<!-- SHADOW OPACITY START-->
									<i class="rs-mini-layer-icon rs-icon-opacity rs-toolbar-icon tipsy_enabled_top" title="<?php _e("Shadow Opacity",'revslider'); ?>" style="margin-right:10px"></i>
									<input data-suffix="" data-steps="0.05" data-min="0" data-max="1" class="rs-staticcustomstylechange pad-input text-sidebar rs-layer-input-field tipsy_enabled_top" title="<?php _e("Shadow Opacity",'revslider'); ?>" style="width:50px" type="text" id="ds_opacity_hover" name="ds_opacity_hover" value="1">
									<span class="rs-layer-toolbar-space" style="margin-right:15px"></span>
			...
			<div class="layer-settings-toolbar" id="rs-animation-content-wrapper" style="display:none">
				<p style="margin:0; border-bottom:1px solid #ddd">
					...
					<span class="rs-layer-toolbar-box" style="">
						...
						<span class="show-on-sfx_in">
							<i class="rs-mini-layer-icon rs-icon-color rs-toolbar-icon tipsy_enabled_top" title="<?php _e("SFX Color",'revslider'); ?>"></i>
				...
				<div id="extra_start_animation_settings" class="hide-on-sfx_in extra_sub_settings_wrapper" style="margin:0; background:#fff; display:none; " >
					...
					<div class="float_left" style="display:inline-block;padding:0px 0px;">
							<div class="inner-settings-wrapper">
				...
				<p style="margin:0;">
					...
					<span class="rs-layer-toolbar-box" style="">
						...
						<select class="rs-inoutanimationfield rs-layer-input-field tipsy_enabled_top" title="<?php _e("Animation Easing",'revslider'); ?>" style="width:135px"  id="layer_endeasing" name="layer_endeasing">
							...
							<span class="show-on-sfx_in">
								<i class="rs-mini-layer-icon rs-icon-color rs-toolbar-icon tipsy_enabled_top" title="<?php _e("SFX Color Out",'revslider'); ?>"></i>
			...
			<div class="layer-settings-toolbar" id="rs-attribute-content-wrapper" style="display:none;">
				...
				<div>
					...
					<!-- TABINDEX -->
					<span class="rs-layer-toolbar-box">
						<span><?php _e("Tabindex",'revslider'); ?></span>
						<span class="rs-layer-toolbar-space"></span>
